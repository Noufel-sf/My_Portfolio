...
function Skills() {
   ...
   <div id='Skills' className="">    
        ...
        <h1 className='capitalize text-6xl tracking-[3px]'>my skills</h1>
        ...
        <div className="flex items-center justify-around gap-12 flex-wrap w-full">
                <div className="flex items-center gap-8 flex-col" data-aos="fade-up">
                    <h2 className='text-5xl capitalize tracking-[3px]'>soft skills</h2>
                ...
                <div className="flex items-center gap-8 flex-col" data-aos="fade-up">
                    <h2 className='text-5xl capitalize tracking-[3px]'>project managment</h2>
                    <ul className='flex flex-col gap-4'>
                    ...
                    <div className="flex items-center gap-8 flex-col" data-aos="fade-up">
                    <h2 className='text-5xl capitalize tracking-[3px]'>development tools</h2>
                    <ul className='flex flex-col gap-4'>
